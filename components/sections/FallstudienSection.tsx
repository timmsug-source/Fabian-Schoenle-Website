...
/**
 * Baut die Vorher-/Nachher-Punkte einer Fallstudie aus dem CMS:
 * fallstudienN_vorher_punkt1, _punkt2, … — die Anzahl ist NICHT begrenzt,
 * im CMS ergänzte Punkte erscheinen automatisch. Ohne CMS-Inhalte (oder wenn
 * alle leer sind) greifen die Standardtexte.
 */
function cmsPunkte(
